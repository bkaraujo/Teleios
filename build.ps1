...
.\vendor\llvm\compile.ps1 -Target "engine" -Location "$ROOTFS/engine/src" -CFlags $EngineCFlags -IFlags "-I$ROOTFS/engine/src" -DFlags "-DCGLM_STATIC -DTELEIOS_BUILD_$Build -DTELEIOS_EXPORT -D_CRT_SECURE_NO_WARNINGS"
