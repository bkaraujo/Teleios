...
$DFlags = "-DCGLM_STATIC -D_UNICODE -DUNICODE"
...
$CFlags = "-std=c11 -g -Wall -Werror -march=x86-64 -Wno-unused-but-set-variable "
$IFlags = "-I$ROOTFS/engine/src"
$DFlags = "-DTL_BUILD_ALPHA -DTL_EXPORT -DTL_TARGET_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_UNICODE -DUNICODE"
...
$DFlags = "-DTL_BUILD_ALPHA -DTL_TARGET_WINDOWS -D_CRT_SECURE_NO_WARNINGS -D_UNICODE -DUNICODE"
...
Write-Host "clang $LFlags $(Get-ChildItem -Path $SANDBOXFS -Filter "*.o" -Recurse -File) -o sandbox.exe"
Invoke-Expression "clang $LFlags $(Get-ChildItem -Path $SANDBOXFS -Filter "*.o" -Recurse -File) -o sandbox.exe"
